...
一个可直接在浏览器中打开的横版像素平台跳跃游戏。玩家需要穿越 12 个主题关卡，收集金币和钻石，躲避尖刺、普通/精英/远程/冲锋/重装敌人与 boss，逐步扩展技能库，并在后半段获得技能强化。
...
商店后期还会解锁 `星盾护体` 和 `疾速施法` 两个被动技能，用于应对后半程更密集的远程攻击和冲锋压制。

## 关卡与规则

当前版本包含 12 个可游玩的主题关卡：草原、洞窟、天空、熔岩、冰雪、终焉洞窟、水晶遗迹、菌光森林、机械工坊、霓虹雨城、时钟高塔和星渊王座。

玩家初始有 3 条生命。碰到尖刺、敌人侧面、敌方弹幕或掉出世界会损失生命并重生。踩到史莱姆可以消灭它并反弹，冲刺、火球和震地也能击败敌人。后半程会出现会发射晶弹的远程怪、主动冲刺追击的冲锋怪和高血量重装怪，少量钻石每颗价值 5 金币。

关卡中的绿色复活旗是检查点。触碰后，下一次失误会从最新检查点复活。第 7 关和第 12 关存在 boss，boss 存活时终点旗会被锁定，击败后才能过关。水晶史莱姆会远程发射晶弹，星渊王会发射虚空弹幕并在二阶段蓄力震波，裂地冲击可打断该蓄力。商店中“下次冒险生命 +1”是单局消耗品，会在下一次开局生效并清零。

## 角色

商店可购买并切换角色。红帽旅人均衡；风语斥候速度更快并自带二段跳；余烬术士自带火球；磐石守卫生命更多并自带震地；电光游侠自带冲刺和疾速施法；星辉先知自带磁铁和星盾。
